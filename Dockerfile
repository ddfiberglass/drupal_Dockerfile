...
RUN cd /opt/bitnami/drupal && composer config --no-plugins allow-plugins.cweagans/composer-patches true && composer require drupal/ctools drupal/admin_toolbar drupal/field_permissions drupal/search_api:"^1.34" drupal/search_api_solr drupal/facets drupal/address drupal/simplenews drupal/pathauto drupal/smart_date drupal/smtp drupal/honeypot drupal/role_expire drupal/symfony_mailer drupal/next cweagans/composer-patches drupal/decoupled_router drupal/simple_oauth drupal/subrequests --update-with-dependencies
