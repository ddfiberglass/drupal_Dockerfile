...
RUN cd /opt/bitnami/drupal && composer require drupal/taxonomy_manager drupal/ctools:^3.11 drupal/admin_toolbar drupal/field_permissions drupal/search_api drupal/search_api_solr drupal/facets drupal/address drupal/pathauto drupal/smart_date drupal/smtp drupal/honeypot --update-with-dependencies
