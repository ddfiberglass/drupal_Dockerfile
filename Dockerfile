...
RUN set -eux; \
	...
	rmdir /var/www/html; \
	ln -sf /opt/bitnami/drupal/web /var/www/html; \
	# delete composer cache
	rm -rf "$COMPOSER_HOME"

ENV PATH=${PATH}:/opt/bitnami/drupal/vendor/bin
