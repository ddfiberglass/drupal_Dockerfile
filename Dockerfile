...
RUN cd /opt/bitnami/drupal && drush theme:enable claro olivero && drush en smtp field_permissions search_api facets chosen address profile metatag pathauto geofield field_group leaflet geocoder geolocation taxonomy_manager && drush pmu search
