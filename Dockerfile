...
RUN cd /opt/bitnami/drupal && composer require drupal/ctools drupal/admin_toolbar drupal/field_permissions drupal/search_api drupal/search_api_solr drupal/facets drupal/address drupal/simplenews:^4.0@RC drupal/pathauto drupal/smart_date drupal/smtp drupal/honeypot drupal/role_expire --update-with-dependencies
